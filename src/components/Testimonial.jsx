...
<div className=" my-7 font-[sans-serif] max-w-6xl mx-auto bg-slate-50">
  <div className="max-w-2xl mt-3 mx-auto text-center">
    <h2 className="text-3xl font-bold text-gray-800">What our happy client say</h2>
    <p className="text-sm mt-6 leading-relaxed text-gray-500">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam minim aute sit. Elit occaecat officia et laboris Lorem minim. Officia do aliqua adipisicing ullamco in</p>
  </div>
